...
function EquipmentTable() {
  ...
  const deleteequipement = async (id) => {
    ...
    setEquipements(
      equipements.filter((equipement) => equipement.id_equipement !== id)
    );
  };
    ...
    <div id="equip-table">
      <div className="tb-equipement">
          ...
          <tbody>
            {filteredequipements.map((equipement) => (
              <tr key={equipement.id_equipement}>
                ...
                <td>
                  <button onClick={() => deleteequipement(equipement.id)}>
                    Supprimer
                  </button>
                </td>
              </tr>
        ...
        <Link to="/AjoutEquipement">
          <button id="add-btn">Ajouter un equipement</button>
        </Link>
      </div>
    </div>
  );
