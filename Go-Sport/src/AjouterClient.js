    ...
    return (
      <div>
        ...
        <form onSubmit={handleSubmit1}>
          ...
          <button type="submit" disabled={!isValidEmail || !isValidPassword || password !== confirmPassword} style={{ backgroundColor: isValidEmail && isValidPassword && password === confirmPassword ? 'orange' : 'grey' }}>Ajouter</button>
        </form>
      </div>
    );
  }
