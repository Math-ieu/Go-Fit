...
const AjoutPlanning = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <select value={entraineur} onChange={(e) => setEntraineur(e.target.value)} required>
      ...
      <select value={salle} onChange={(e) => setSalle(e.target.value)} required>
        <option value="">Sélectionnez une salle</option>
        <option value="1">Salle 1</option>
        <option value="2">Salle 2</option>
      </select>
      <input type="text" value={nom_session} onChange={(e) => setNomSession(e.target.value)} placeholder="Nom de la session" required />
      <input type="number" value={effectif_max} onChange={(e) => setEffectifMax(e.target.value)} placeholder="Effectif max" required />
